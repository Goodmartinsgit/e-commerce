...
//       //cheking if product exixt
//       const existingProduct = storedCartItems.find((item) => parseInt(item?.id) === parseInt(prod?.id));

//       if (!existingProduct) {
//         toast.error("Product does not exist in the cart")
